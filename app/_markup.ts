...
<section id="agentPane" style="margin-bottom: 28px; border: 1px solid var(--green-border); border-radius: var(--radius-sm); padding: 16px;">
      ...
      <div class="provenance-table" id="provenanceTable">
        ...
        <div class="provenance-row">
          <div class="cand-col">
            ...
            <span class="prov-source">Groq · transcription only</span>
          </div>
